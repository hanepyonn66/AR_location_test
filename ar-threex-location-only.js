!function(t, e) {
    ...
    return (()=>{
        ...
        class i {
            ...
            setGpsOptions(t={}) {
                void 0 !== t.gpsMinDistance && (this._gpsMinDistance = t.gpsMinDistance),
                void 0 !== t.gpsMinAccuracy && (this._gpsMinAccuracy = t.gpsMinAccuracy),
            ...
            stopGps() {
                return null !== this._watchPositionId && (navigator.geolocation.clearWatch(this._watchPositionId),
                this._watchPositionId = null,
                !0)
            }
            ...
            _gpsReceived(t) {
                ...
                e >= this._gpsMinDistance && (this._lastCoords.longitude = t.coords.longitude,
                this._lastCoords.latitude = t.coords.latitude,
                this.initialPositionAsOrigin && !this.initialPosition && this.setWorldOrigin(t.coords.longitude, t.coords.latitude),
                this.setWorldPosition(this._camera, t.coords.longitude, t.coords.latitude),
                this._eventHandlers.gpsupdate && this._eventHandlers.gpsupdate(t, e)))
            }
            _haversineDist(t, i) {
        ...
        class s {
            constructor(t, i) {
                ...
                void 0 === i ? (o = document.createElement("video"),
                o.setAttribute("autoplay", !0),
                o.setAttribute("playsinline", !0),
                o.style.display = "none",
                document.body.appendChild(o)) : o = document.querySelector(i),
                ...
                if (this.sceneWebcam.add(n),
                this.cameraWebcam = new e.OrthographicCamera(-.5,.5,.5,-.5,0,10),
        ...
        const r = new e.Vector3(0,1,0)
          , a = new e.Vector3(0,0,1)
          , h = new e.Euler
          , c = new e.Quaternion
          , d = new e.Quaternion(-Math.sqrt(.5),0,0,Math.sqrt(.5))
          , l = {
            type: "change"
        };
        class u extends e.EventDispatcher {
            constructor(t) {
                super(),
                !1 === window.isSecureContext && console.error("THREE.DeviceOrientationControls: DeviceOrientationEvent is only available in secure contexts (https)");
                const i = this
                  , o = new e.Quaternion;
                this.object = t,
                ...
                this.connect = function() {
                    s(),
                    void 0 !== window.DeviceOrientationEvent && "function" == typeof window.DeviceOrientationEvent.requestPermission ? window.DeviceOrientationEvent.requestPermission().then((t=>{
                        "granted" === t && (window.addEventListener("orientationchange", s),
                ...
                this.update = function() {
                    ...
                    if (t) {
                        let n = t.alpha ? e.MathUtils.degToRad(t.alpha) + i.alphaOffset : 0
                          ...
                          , u = t.gamma ? e.MathUtils.degToRad(t.gamma) : 0;
                        const p = i.screenOrientation ? e.MathUtils.degToRad(i.screenOrientation) : 0;
                        if (this.smoothingFactor < 1) {
                            if (this.lastOrientation) {
                                ...
                                u = this._getSmoothedAngle(u + this.HALF_PI, this.lastOrientation.gamma, t, Math.PI)
                            } else
                                s += Math.PI,
                                u += this.HALF_PI;
                        ...
                        !function(t, o, n, s, l) {
                            h.set(n, o, -s, "YXZ"),
                            t.setFromAxisAngle(r, e.MathUtils.degToRad(i.headingOffset)),
                            t.multiply(c.setFromEuler(h)),
                            t.multiply(d),
                            t.multiply(c.setFromAxisAngle(a, -l))
                        }(i.object.quaternion, n, this.smoothingFactor < 1 ? s - Math.PI : s, this.smoothingFactor < 1 ? u - this.HALF_PI : u, p),
                        8 * (1 - o.dot(i.object.quaternion)) > 1e-6 && (o.copy(i.object.quaternion),
                        i.dispatchEvent(l))
                    }
                }
                ,
